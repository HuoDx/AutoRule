...
class RemoteExperienceMaker(BaseExperienceMaker):
    ...
    def make_experience(self, samples_list: List[Samples]) -> List[Experience]:
        ...
        for i, (samples, action_log_probs, base_action_log_probs, value, rewards, rule_rewards, model_rewards, rule_dict) in enumerate(
            zip(samples_list, action_log_probs_list, base_action_log_probs_list, value_list, rewards_list, rule_rewards_list, model_rewards_list, rule_dicts)
        ):
