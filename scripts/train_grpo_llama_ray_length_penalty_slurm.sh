...
#SBATCH -p general        
#SBATCH -J llama_grpo_length_penalty
#SBATCH -N 1
#SBATCH -t 0-24:00:00
...
srun --overlap --nodes=1 --ntasks=1 -w "$node_1" \
    ...
    bash -c "apt-get update && apt-get install -y libopenmpi-dev git build-essential cmake; \
             ...
             -- python3 -m openrlhf.cli.train_ppo_ray \
                 ...
                 --save_path /root/checkpoint2/ar-llama-3-8b-grpo-length-penalty \
                 --ckpt_path /root/checkpoint2/ar-llama-3-8b-grpo-length-penalty-ckpt \
                 --save_hf_ckpt \
                 --max_ckpt_num 2 \
                 --save_steps 2 \
