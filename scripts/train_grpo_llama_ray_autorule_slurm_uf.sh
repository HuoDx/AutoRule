...
#SBATCH -p general        
#SBATCH -J llama_grpo_autorule_uf
#SBATCH -N 1
#SBATCH -t 0-48:00:00
...
srun --overlap --nodes=1 --ntasks=1 -w "$node_1" \
    ...
    bash -c "apt-get update && apt-get install -y libopenmpi-dev git build-essential cmake; \
             ...
             -- python3 -m openrlhf.cli.train_ppo_ray \
                 ...
                 --judge_vllm_num_engines 4 \
                 --judge_vllm_tensor_parallel_size 1 \
                 --use_autorule \
                 --rules_version uf \
                 ...
                 --save_path /root/checkpoint2/ar-llama-3-8b-grpo-autorule-uf \
                 --ckpt_path /root/checkpoint2/ar-llama-3-8b-grpo-autorule-uf-ckpt \
                 --max_ckpt_num 2 \
                 --save_steps 2 \
